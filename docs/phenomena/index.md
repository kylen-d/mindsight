...
| Gaze Following | A participant shifts gaze in the same direction another person is looking | `--gaze-follow` | [gaze-following.md](gaze-following.md) |
| Gaze Leadership | Identifying which participant initiates shared attention episodes | `--gaze-leader` | [gaze-leadership.md](gaze-leadership.md) |
| Gaze Aversion | A participant actively avoids eye contact by looking away | `--gaze-aversion` | [gaze-aversion.md](gaze-aversion.md) |
| Attention Span | Duration a participant sustains fixation on a single target | `--attn-span` | [attention-span.md](attention-span.md) |
| Scanpath | The sequential trajectory of a participant's gaze across objects | `--scanpath` | [scanpath.md](scanpath.md) |

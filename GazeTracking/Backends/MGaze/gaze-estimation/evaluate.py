...
from utils_gaze.helpers import angular_error, gaze_to_3d, get_dataloader, get_model
...
def evaluate(params, model, data_loader, idx_tensor, device):
    ...
    Args:
        ...
        data_loader (torch.utils_gaze.data.DataLoader): DataLoader for the test dataset.

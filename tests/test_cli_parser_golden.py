...
which drive generation -- is caught: 156 actions = 113 core (72 schema-cli + 12
...
def test_parser_prog_and_action_count():
    ...
    assert len(spec["actions"]) == 156
    assert len(golden["actions"]) == 156

...
which drive generation -- is caught: 157 actions = 114 core (73 schema-cli + 12
...
def test_parser_prog_and_action_count():
    ...
    assert len(spec["actions"]) == 157
    assert len(golden["actions"]) == 157

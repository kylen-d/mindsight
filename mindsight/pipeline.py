...
from mindsight.PostProcessing.RayForming import GazeLLEBlender, ObjectSnap
...
class Pipeline:
    ...
    def from_config(cls, config, *, yolo, face_det, gaze_eng,
        ...
        from config.
        """
        from mindsight.config_compat import to_dataclasses
...
def _run_video(source, *, yolo, face_det, gaze_eng,
    ...
    from mindsight.Phenomena.Default import JointAttentionTracker

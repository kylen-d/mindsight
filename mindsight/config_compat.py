...
EXCLUDED_CLI_FLAGS: dict[str, str] = {
    ...
    "--vp-condition":      "model wiring: YOLOE VP condition-tag subset (v1.3.1)",
    "--vp-ignore-conditions": "model wiring: YOLOE VP full-prompt override (v1.3.1)",
...
YAML_UNMAPPED: dict[str, str] = {
    ...
    "detection.vp_condition":    "model wiring: YOLOE VP condition-tag subset",
    "detection.vp_ignore_conditions": "model wiring: YOLOE VP full-prompt override",
...
_YAML_MAP: dict[str, str] = {
    ...
    'detection.vp_condition': 'vp_condition',
    'detection.vp_ignore_conditions': 'vp_ignore_conditions',

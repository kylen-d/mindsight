"""
ms.io.writers -- Output sinks for the pipeline.
...
historically defined in ``ms.DataCollection.dashboard_output``; they are pure
IO (not drawing) and moved here as part of the SP1.2 io extraction.
``ms.DataCollection`` re-exports them for backward compatibility.
"""

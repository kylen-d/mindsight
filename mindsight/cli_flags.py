...
CORE_FLAGS: tuple[FlagSpec, ...] = (
    ...
    FlagSpec(flag='--rf-len-slew', dest='rf_len_slew', schema_path='rayforming.rf_len_slew', metavar='N', help='When a length refresh re-latches ray length, slew toward the new value over N frames instead of snapping instantly. Experimental: interacts with the length-hold decay and can read as bounce rather than smoothing. 0 = instant snap (default: 0).', group='Ray Forming (Gazelle blend)'),

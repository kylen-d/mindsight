...
CORE_FLAGS: tuple[FlagSpec, ...] = (
    ...
    FlagSpec(flag='--rf-len-slew', dest='rf_len_slew', schema_path='rayforming.rf_len_slew', metavar='N', help='When a length refresh re-latches ray length, slew toward the new value over N frames instead of snapping instantly. 0 = instant snap, the pre-v1.1 behavior (default: 5 -- half the default length refresh gap).', group='Ray Forming (Gazelle blend)'),

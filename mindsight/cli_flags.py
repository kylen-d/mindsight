...
CORE_FLAGS: tuple[FlagSpec, ...] = (
    ...
    FlagSpec(flag='--project', dest='project', schema_path=None, default=None, metavar='DIR', help='Run in project mode: process all videos in DIR/Inputs/Videos/ using DIR/Pipeline/pipeline.yaml as config.'),
    ...
    FlagSpec(flag='--rf-gazelle-model', dest='rf_gazelle_model', schema_path=None, default=None, metavar='PATH', help='Path to a Gaze-LLE checkpoint (.pt) for Gazelle blend ray forming. Used alongside a pitch/yaw backend (L2CS, MGaze, etc.) to periodically correct rays with Gaze-LLE heatmaps.', group='Ray Forming (Gazelle blend)'),

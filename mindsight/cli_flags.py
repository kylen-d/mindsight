...
CORE_FLAGS: tuple[FlagSpec, ...] = (
    ...
    FlagSpec(flag='--model', dest='model', schema_path=None, default='yolo11n.pt', help='Object Detection Model (default: yolo11n.pt since v1.1; yolo11n.onnx in the Models tab is a faster option for CPU-bound installs)'),
    ...
    FlagSpec(flag='--face-model', dest='face_model', schema_path=None, default='r34', choices=('mnet025', 'mnet050', 'mnet_v1', 'mnet_v2', 'r18', 'r34'), metavar='NAME', help='RetinaFace backbone variant (default: r34 -- the v1.1 eval pick: best accuracy AND ~40%% faster than mnet_v2 on the CoreML path; weights auto-download on first use).'),
    ...
    FlagSpec(flag='--face-eye-origin', dest='face_eye_origin', schema_path='gaze.face_eye_origin', kind='store_true', help='Anchor gaze rays at the detected eye midpoint (RetinaFace landmarks) instead of the face-bbox centre (default: ON since v1.1; disable with --no-face-eye-origin).'),
    FlagSpec(flag='--no-face-eye-origin', dest='no_face_eye_origin', schema_path=None, default=False, kind='store_true', help='Anchor gaze rays at the face-bbox centre (the pre-v1.1 behavior), overriding the eye-midpoint default.'),

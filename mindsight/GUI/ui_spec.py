...
_EXCLUDED_FIELDS: dict[str, dict] = {
    ...
    "overlay_theme": dict(group="performance", widget="combo",
                          default="classic", label="Overlay theme",
                          choices=("classic", "mindsight")),
...
_GROUP_TREE: list[_GroupSpec] = [
    ...
    _GroupSpec("performance", "Performance && Tracking",
               ["skip_frames", "detect_scale", "mgaze_reuse_eps",
                ...
                "gaze_debug",
                "fast", "skip_phenomena", "lite_overlay", "overlay_theme",
                "no_dashboard", "profile"]),

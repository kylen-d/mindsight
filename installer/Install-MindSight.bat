...
if not defined MINDSIGHT_RELEASE_BASE_URL set "MINDSIGHT_RELEASE_BASE_URL=https://github.com/kylen-d/mindsight/releases/download/v1.0.0"
set "RELEASE_BASE_URL=%MINDSIGHT_RELEASE_BASE_URL%"
if not defined MINDSIGHT_RELEASE_WHEEL_URL set "MINDSIGHT_RELEASE_WHEEL_URL=%RELEASE_BASE_URL%/mindsight-1.0.0-py3-none-any.whl"
